...
| 14 | [`headless.md`](headless.md) | **What does running without a GPU actually buy?** Not dispatch — ~18 ns a tick. What Unreal really does for servers, verified, and why G1c needs two mechanisms rather than a choice between them. |
