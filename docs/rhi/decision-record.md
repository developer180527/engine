...
9.11 ms GPU, at 50 000 real props** (`src/render/issues.md` R20; of the other
6.0 ms, the profiled phases are expand 3.2, submit 1.4, cull 0.85 and shadow
0.19 — 5.64, with the remaining ~0.36 unattributed in the source). An RHI rewrite does
