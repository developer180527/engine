...
| geometry LOD | **none** | discrete LODs, impostors, or virtualised clusters |
...
1. ~~**Submesh-granular visible sets.**~~ **DONE 2026-08-05** (issues.md R18). Ranges
   ...
   parents.
2. **LOD.** The missing system with the biggest effect on real scenes, and it cuts both
   draws and triangles. Nothing else reduces the workload itself.
